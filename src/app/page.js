  ...
  return (
     ...
     <div >
      ...
      >
                <div className={styles.hero_content_left}>
                  ...
                  <h1>DTC Growth Partners For Brands With Big Ideas</h1>
                  <h3>
                    We're an omni-channel e-commerce marketing agency obsessed
              ...
              <div className={styles.container}>
                <div className={styles.w_wave_overlay}>
                  <ul>
                    <li>About</li>
                    <li>Latest Case Study</li>
                    <button className={styles.apply_now_button}>
                      Apply Now{" "}
                    </button>
                  </ul>
                </div>
                ...
                <div className={styles.stat_feature}>
                  <div className={styles.stat_card}>
                    ...
                    <div className={styles.stat_btn_wrapper}>
                      <button className={styles.transparent_btn}>
                        Apply Now
                      </button>
                      <button className={styles.secondry_btn}>
                        Free Training
                      </button>
                    </div>
                  </div>
            ...
            <div className={styles.priority_container}>
              ...
              <div className={styles.message_wrapper}>
                <div className={styles.top_message_wrapper}>
                  ...
                  <div className={styles.message1}>
                    <p>
                      Holy shit what am I going to do with all these orders! -
                      Brody Mongelli Our ROI has been beyond anything we
                      imagined before working with the team at Affluent Agency -
                      Ben Fordham
                    </p>
                    <img
                ...
                <div className={styles.bottom_message_wrapper}>
                  <div className={styles.message}>
                    <p>
                      ...
                      customer database has increased substantially, I couldn't
                      be happier with the team - Jess Collet
                    </p>
                    <img
                      src="./chatbox_right.svg"
                      className={styles.left_chatbox}
                  ...
                  <div className={styles.message1}>
                    <p>
                      Communication is important to us. Tom and the team have
                      always gone above and beyond to ensure our needs are met -
                      Chris Brashni
                    </p>
                    <img
                      src="./chatbox_left.svg"
              ...
              <div className={styles.agency_other}>
                <div className={styles.cont_wrap}>
                  ...
                  <p>
                    Through our sister company The Affluent Academy, we've
                    taught thousands of other agencies how to generate
    ...
    >
              ...
              <div className={styles.footer}>
                ...
                />{" "}
                <p>
                  Omni-channel e-commerce marketing <br /> agency obsessed with
                  ROI.
                </p>
